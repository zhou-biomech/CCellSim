% /home/zhou/Documents/Cell2D-Data/MultiCells-CenterSource/data
...
t1 = [0:360/8 :360-360/8 ]' +  360/24;
t2 = [0:360/12:360-360/12]';
...
Rac3=-Rac.amt*Rac.a2n*k_GAP_Rac;    %s-1   self delay
Rac4=0;
Rac4=0.02*GEF_Rac.eff.*Rac_in.amt*Rac.a2n;
Rac.src=Rac1+Rac2+Rac3+Rac4;
Rac.src = Rac.src./Rac.a2n*dt;

% Rac_in
Rac_in.src=-(Rac1+Rac2+Rac3+Rac4);
...
Rho.src=Rho1+Rho2+Rho3+Rho4;
Rho.src = Rho.src./Rho.a2n*dt;
        
% Rho_in
Rho_in.src=-(Rho1+Rho2+Rho3+Rho4);
