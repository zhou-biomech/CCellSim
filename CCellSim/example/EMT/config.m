% /home/zhou/Documents/Cell2D-Data/MultiCells-CenterSource/multicells20221120/data
...
t1 = [0:360/6:360-360/6]' +  360/12;
t2 = [0:360/6:360-360/6]';

cel = [ [0,0; r1.*cosd(t1) r1.*sind(t1); r2.*cosd(t2) r2.*sind(t2)], ones(n,2).*[5, nndes]];
...
13 'fMLP'         'mebre'  '[]'    'GPCR'         NaN  NaN    0   0.04    0
...
Rho5 = 0.1.*isadh.*Rho_in.amt*Rho.a2n; 
Rho5 = -Rho5;
